	...
	return (
		<>
			<div className="w-100 bg-dark p-5">
				<div className="row">
					<div className="col-12 col-lg-3 text-light mt-5 mt-lg-1 ">
						<h4>Contact us</h4>
						<div className="mt-4 d-flex justify-content-between align-items-center">
							<i class="bi bi-telephone"></i>
							<span className="ms-1">+998-91-687-88-98</span>
						</div>
						<div className="mt-4 d-flex justify-content-between align-items-center">

							<i class="bi bi-envelope"></i>
							<span className="ms-1">manager@shop.com</span>
						</div>

						<div className="mt-4 d-flex justify-content-between align-items-center">

							<i class="bi bi-geo-alt"></i>
							<span className="ms-1">Location store</span>
						</div>
					</div>
					...
					<div className="col-12 col-lg-3 text-light mt-5 mt-lg-1">
						...
						<div className="mt-4 d-flex justify-content-between align-items-center">
							...
							<span>Saller login</span>
						</div>

						<div className="mt-4 d-flex justify-content-between align-items-center">

							<span>Saller Sign up</span>
						</div>

						<div className="mt-4 d-flex justify-content-between align-items-center">

							<span>Saller Handbook</span>
						</div>

						<div className="mt-4 d-flex justify-content-between align-items-center">

							<span>Saller Control</span>
						</div>

						<div className="mt-4 d-flex justify-content-between align-items-center">

							<span>Panel Seller FAQs</span>
						</div>
					...
					<div className="col-12 col-lg-3 text-light mt-5 mt-lg-1 ">
						...
						<div className="mt-4 d-flex justify-content-between align-items-center">
							<h6>Contary to popular belief of Lorem ipsm Latih amet itin from</h6>
						</div>
						...
						<div className="mt-4 d-flex justify-content-between align-items-center" >
							<input className="form-control" placeholder="Your E-mail adress..." />
							<button className="btn"><i class="bi bi-send text-light"></i></button>
						</div>
