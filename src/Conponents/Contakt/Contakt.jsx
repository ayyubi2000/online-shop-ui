            ...
            <div className='row '>
                <div className="col-lg-5">
                    <div className="row">
                        ...
                        <div className="col-lg-12">
                            <h4 className='mt-4 ms-5'>Username: {localStorage.getItem('Name')}</h4>
                            <h4 className='mt-3 ms-5'>Lastname: {localStorage.getItem('Lastname')}</h4>
                            <h4 className='mt-3 ms-5'>Number:  {localStorage.getItem('Number')} </h4>
                ...
                <div className='col-lg-2'>
                    <button className='btn btn-success ms-5 mt-4'  onClick={logout_user}>Log Out</button>
                </div>
            </div>
        </div>
